...
def main(config):
    ...
    #
    #     src_gt = os.path.join(config.origin_GT_path, GT_list[idx])
    #     dst_gt = os.path.join(config.train_GT_path, GT_list[idx])
    #
    #     if os.path.exists(src) and os.path.exists(src_gt):
    #         copyfile(src, dst)
...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='./data/data')
    parser.add_argument('--origin_GT_path', type=str, default='./data/data_GT')

    parser.add_argument('--train_path', type=str, default='./data/train/')
    parser.add_argument('--train_GT_path', type=str, default='./data/train_GT/')
    parser.add_argument('--valid_path', type=str, default='./data/valid/')
    parser.add_argument('--valid_GT_path', type=str, default='./data/valid_GT/')
    parser.add_argument('--test_path', type=str, default='./data/test/')
    parser.add_argument('--test_GT_path', type=str, default='./data/test_GT/')
